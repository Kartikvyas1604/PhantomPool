    ...
    setupRoutes() {
        ...
        this.app.get('/api/wallet/:address/balance', async (req, res) => {
            try {
                ...
                const balance = await this.solanaService.getRealBalance(address, token || 'SOL');
                res.json({
                    success: true,
        ...
        this.app.get('/api/risk/circuit-breaker', async (req, res) => {
            try {
        ...
        this.app.get('/api/compliance/transactions', async (req, res) => {
            try {
...
exports.default = ProductionPhantomPoolServer;
//# sourceMappingURL=api-server-production.js.map